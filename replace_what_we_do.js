...
const newSection = `<section className="rule-top" id="what-we-do">
          <div className="wrap">
            ...
            <div className="svc-footer mt-large" style={{borderTop: "1px solid var(--light-sage)", gridTemplateColumns: "96px minmax(0,4fr) minmax(0,6fr)", paddingBottom: "64px"}}>
              <div className="svc-kind" style={{paddingLeft: "0", color: "var(--ink)"}}>After handover</div>
              <div className="svc-body" style={{gridColumn: "3 / 4"}}>
